/*!
 * ol-elevation-parser - v1.3.4
 * https://github.com/GastonZalba/ol-elevation-parser#readme
 * Built: Mon May 01 2023 20:06:48 GMT-0300 (Argentina Standard Time)
*/
...
class ReadFromImage {
    ...
    async read(coordinate) {
        ...
        if (this._resolution === 'current') {
            ...
            resolution =
                this._source.getResolutions()[this._source.getResolutions().length - 1];
        }
        else {
