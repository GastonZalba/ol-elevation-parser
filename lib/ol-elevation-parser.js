/*!
 * ol-elevation-parser - v1.3.11
 * https://github.com/GastonZalba/ol-elevation-parser#readme
 * Built: Sun Aug 13 2023 18:43:14 GMT-0300 (Argentina Standard Time)
*/
...
class ElevationParser extends Control {
    constructor(options$1) {
        ...
        this._getZFromSampledCoords = async (coords, optOptions = null) => {
            ...
            const _resolution = optOptions.tilesResolution || this.getTilesResolution();
...
export { GeneralEventTypes, ElevationParser as default };
