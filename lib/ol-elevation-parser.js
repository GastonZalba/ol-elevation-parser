    ...
    getElevationValues(feature) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof source === 'function') {
                ...
                ({ mainCoords, contourCoords } = yield source(feature, sampledCoords));
            }
            else {
                mainCoords = yield this._getZFromSampledCoords(sampledCoords.mainCoords);
                // Only Polygons
                if (sampledCoords.contourCoords) {
                    contourCoords = yield this._getZFromSampledCoords(sampledCoords.contourCoords);
                }
            }
