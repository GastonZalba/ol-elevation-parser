/*!
 * ol-elevation-parser - v1.3.2
 * https://github.com/GastonZalba/ol-elevation-parser#readme
 * Built: Sun Apr 30 2023 11:33:50 GMT-0300 (Argentina Standard Time)
*/
...
class ReadFromImage {
    constructor(source, calculateZMethod, resolution, map) {
        this._draws = {};
        this._projection =
    ...
    async read(coordinate) {
        ...
        const tileCoord = this._tileGrid.getTileCoordForCoordAndResolution(coordinate, resolution);
    ...
    _addPropertyEvents() {
        ...
        const prepare = () => {
            ...
            if (!(source instanceof Function) &&
                this.get('calculateZMethod') !== 'getFeatureInfo') {
                this._readFromImage = new ReadFromImage(source, this.get('calculateZMethod'), this.get('tilesResolution'), this.getMap());
            }
            else {
